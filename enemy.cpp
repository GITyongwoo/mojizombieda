...
// マクロ定義
//*****************************************************************************
#define	MODEL_ENEMY0			"data/MODEL/tonosensei.obj"		// 読み込むモデル名
#define MODEL_ENEMY1			"data/MODEL/bikaiin.obj"
...
static INTERPOLATION_DATA move_tbl[] = {	// pos, rot, scl, frame
	{ XMFLOAT3(   0.0f, ENEMY_OFFSET_Y, 500.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(4.0f, 4.0f, 1.0f), 60*2 },
	{ XMFLOAT3(	  0.0f, ENEMY_OFFSET_Y, 500.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(4.0f, 4.0f, 1.0f), 60*2 },
	{ XMFLOAT3(   0.0f, ENEMY_OFFSET_Y, 500.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(4.0f, 4.0f, 1.0f), 60*2 },
	{ XMFLOAT3(   0.0f, ENEMY_OFFSET_Y, 500.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(4.0f, 4.0f, 1.0f), 60*2 },
...
HRESULT InitEnemy(void)
{
	...
	{
		LoadModel(MODEL_ENEMY0, &g_Enemy[i].model);
		LoadModel(MODEL_ENEMY1, &g_Enemy[i].model);
		g_Enemy[i].load = true;

		g_Enemy[i].pos = XMFLOAT3(50.0f, ENEMY_OFFSET_Y, -200.0f);
